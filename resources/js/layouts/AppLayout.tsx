      ...
      >
        ...
        >
          ...
          <Flex gap={4} align="center">
            ...
            <Indicator disabled={page.props.auth.user.data.notificationsCount < 1} position="bottom-end" withBorder
                       color='red'>
              <ActionIcon
                variant="subtle"
                size="xl"
            ...
            <Menu shadow="md">
              <Menu.Target>
                ...
                >
                  <Flex py={2} gap={12}>
                    <Avatar size="2rem" src={page.props.auth.user.data.avatar} alt={page.props.auth.user.data.name}
                            radius="xl"/>
                    <Flex visibleFrom='sm' direction="column" align="start">
                      ...
                      <Text size="xs">
                        {page.props.auth.user.data.email}
                      </Text>
                    </Flex>
                  </Flex>
                </Button>
