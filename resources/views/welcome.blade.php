<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{isRTL() ? 'rtl' : 'ltr'}}" class="dark">
<head>
  <meta charset="utf-8">
...
<header class="bg-gray-100 text-gray-600 body-font">
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <a href="{{route('register')}}"
            class="text-gray-900 bg-gray-300 focus:ring-2 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none dark:focus:ring-gray-800">
      Get Started
    </a>
    @endguest
  </div>
    ...
    <div class="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
      <div class="flex flex-col mb-10 lg:items-start items-center">
        ...
        <div class="flex-grow">
          ...
          <p class="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy.
  ...
  <div class="items-center justify-center py-12 flex">
    @foreach(LaravelLocalization::getSupportedLocales() as $key => $locale)
      @if($key === app()->getLocale())
        <p>{{$locale['native']}}</p>
      @else
        <a class="block text-blue-700 mx-2 hover:underline"
           href="{{ LaravelLocalization::getLocalizedURL($key)  }}">{{$locale['native']}}</a>
      @endif
    @endforeach
  </div>
</footer>
