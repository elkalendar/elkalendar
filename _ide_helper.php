...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function canISendAs($emailOrDomain)
        {
                        /** @var \Dietercoopman\Mailspfchecker\Mailspfchecker $instance */
                        return $instance->canISendAs($emailOrDomain);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function using($server)
        {
                        /** @var \Dietercoopman\Mailspfchecker\Mailspfchecker $instance */
                        return $instance->using($server);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function check($emailOrDomain, $returnCode = false)
        {
                        /** @var \Dietercoopman\Mailspfchecker\Mailspfchecker $instance */
                        return $instance->check($emailOrDomain, $returnCode);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function howCanISendAs($emailOrDomain, $overRuleMessage = null)
        {
                        /** @var \Dietercoopman\Mailspfchecker\Mailspfchecker $instance */
                        return $instance->howCanISendAs($emailOrDomain, $overRuleMessage);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function buildDnsString($emailOrDomain)
        {
                        /** @var \Dietercoopman\Mailspfchecker\Mailspfchecker $instance */
                        return $instance->buildDnsString($emailOrDomain);
        }
...
namespace  { 
            ...
            class Mailspfchecker extends \Dietercoopman\Mailspfchecker\Facades\Mailspfchecker {}
